...
var varx1=0;
var varx2=0;
var varlabelecua1="giovanniok";
var varecuax1=[1, 2, 3, 4, 5, 6, 7];
var varecuay1=[1, 2, 3, 4, 5, 6, 7];
var varidecua1="";

function okecua1(){
varecuay1=[]
varecuax1=[]
varidecua1=buscavalorid("idecua1");
 varidecua1=varidecua1.toLowerCase();

valorid=0
abrir=true;
theplot1=new Fooplot(document.getElementById('container'));
theplot1.addPlot(String(varidecua1),FOOPLOT_TYPE_FUNCTION);
